const en = {
	...
	Settings: {
		...
		modifySharing: 'Modify who can see your calendar',
		languageTitle: 'Change language',
		modifyCalendar: 'Modify Calendar',
		modifyCalendarDescription: 'To delete every events in your calendar, you can clear you calendar, or if you want to remove the Kalend calendar, you can delete it.',
...
const fr = {
	...
	Settings: {
		...
		modifySharing: 'Modifier qui peut voir votre calendrier',
		languageTitle: 'Changer de langue',
		modifyCalendar: 'Modifié le calendrier',
		modifyCalendarDescription: 'Pour supprimer tous les événements de votre calendrier, vous pouvez effacer votre calendrier, ou si vous souhaitez supprimer le calendrier Kalend, vous pouvez le supprimer.',
